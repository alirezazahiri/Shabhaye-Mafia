...
const citizens = [
  ...
  },
  {
    armored: {
      ...
      title: "زره پوش",
      description:
        "با تیر اول و یا رای خروج اول از بازی خارج میشود. در صورتی که با رای برود با افشای نقش خود در بازی می نشیند اما با تیر مافیا فقط زره اش را از دست میدهد ولی نقشش افشا نمی شود",
      max: 1,
      type: "citizen",
    },
  },
